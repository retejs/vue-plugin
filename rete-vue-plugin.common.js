...
function render$e(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$7, [
    vue.createElementVNode("path", { d: _ctx.path }, null, 8 /* PROPS */, _hoisted_2$1)
  ]))
}
...
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    class: vue.normalizeClass(["node", { selected: _ctx.data.selected }]),
    style: vue.normalizeStyle(_ctx.nodeStyles()),
    "data-testid": "node"
  }, [
    vue.createElementVNode("div", _hoisted_1$5, vue.toDisplayString(_ctx.data.label), 1 /* TEXT */),
    vue.createCommentVNode(" Outputs"),
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.outputs(), ([key, output]) => {
      return (vue.openBlock(), vue.createElementBlock("div", {
        class: "output",
    ...
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.controls(), ([key, control]) => {
    ...
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.inputs(), ([key, input]) => {
      return (vue.openBlock(), vue.createElementBlock("div", {
        class: "input",
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    (_ctx.searchBar)
      ...
      : vue.createCommentVNode("v-if", true),
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.getItems(), (item) => {
      return (vue.openBlock(), vue.createBlock(_component_Item, {
        key: item.key,
        onSelect: $event => (item.handler($event)),
        delay: _ctx.delay,
